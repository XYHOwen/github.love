...
/*字符拼接区*/
var introduce =' \/*\n  * Hi,亲爱的林茜小姐姐：我们又见面啦！ \n  * 不知不觉2024年已经开始了，一直都没有好好陪你，难得我有时间和闲心，很多话也不知道从何开口～ \n  * 我知道你一定会来到这里，那就让这个虚拟的独白就当作我们今年快乐时光的开始吧！ \n  * 有点冷清哎～那就先来点音乐吧，如果没有听见背景音乐请你轻点两下屏幕哦～ \n  * 你总让我用自己的方式表达爱意，那么作为一个程序猿,发挥程序猿的特长就送你张网页吧，请原谅我用这种敷衍的形式~  \n  * 好啦，就说这么多啦，那我就要开始啦！你那么爱美那我就先从网页的美化开始吧！\n */';
	var sty1='\n  /* 那就先从背景开始吧～ 既然是仙女那就要粉粉的~ */ \n  body{\n\t background:-webkit-linear-gradient(#f54ea2,#ff7676);\n\t font-family:"微软雅黑";\n   }\n   /* 搬个凳子坐下来酝酿一下，哈哈哈，让代码也歇会儿～ */\n   #wrap{\n\t overflow:auto;\n\t width:40%;\n\t height:420px;\n\t border-radius:5px;\n\t box-shadow:0 0 15px #fff;\n\t font-size:14px;\n\t font-weight:bold;\n   }';
	var trs1 = '\n  \/* 代码也很丑，那我也要让它变得漂亮起来～ *\/';
var lightheight = '\n  #wrap{\n\t background:#002B36;\n\t color: #BE84F2;\n   }\n  .token.property{\n\t color:#64d5ea;\n   }\n   .token.comment{\n\t color:857F6B;\n   }\n';
    var trs2 = '  \/* 现在我也酝酿的差不多啦，那就随便说点吧～先让代码到一边凉快一会~ *\/';
    var scrollRight = '\n  #wrap{\n\t transform: rotateY(-10deg);\n\t position:fixed;\n\t left:53%;\n\t top: 4%;\n\t height: 85%\n   } \n   \/* 嗯～～～，还是正式一点吧，我准备一张纸，慢慢写下来吧～ *\/\n  ';
...
var trs3 = ' \n   \/* 这个看起来不太好看的样子,需要稍作修改好看一丢丢 *\/\n   #loveme h2{\n\t display: inline-block;\n\t border-bottom: 1px solid;\n\t margin: 1em 0 .5em;\n\t font-size: 15px;\n\t font-weight: 700;\n\t line-height: 2;\n\t font-family: microsoft yahei;\n   }\n   #loveme p{\n\t line-height: 1.5; padding: 1em;  }\n   #loveme div p{\n\t margin: 1em;\n\t padding: 1.5em;\n\t background: rgba(221,221,221,.5);\n   } \n  #loveme div Temp{\n\t font-size: 20px; text-align:center ;\n\t padding: .5em;\n\t background: rgba(255,0,0,.5);\n   }\n\t\/*美感不怎么滴,只能这样了~*/';/* *** 最后为大家带来一个小惊喜，倒数三个数  \n\t* 3\n\t* 2\n\t* 1\n\t*** */
	...
	var languagesJudge_No = 1195 ;//独白结束
	var languages_No = 1287 ; //独白开始，代码结束
	var languageTotal_No = 1876 ;  //总结束
	var SpellSpeed = 1 ;
